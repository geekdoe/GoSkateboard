...
public class WelcomeActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    private void initViews() {
        ...
        SharedPreferences pref2 = getSharedPreferences("first", Activity.MODE_PRIVATE);
        isFirst = pref2.getBoolean("status",true);
        ...
        guideFour.findViewById(R.id.toLogin).setOnClickListener(new View.OnClickListener() {
            @Override
